...
public class LevelFactory {
    ...
    public static Level loadLevel(int levelId, GameScreen gs){
        ...
        switch(levelId){
            ...
            case 6:
                return generateLevelTwo(gs);
            case 7:
                return generateLevelThree(gs);
            case 8:
                return generateLevelFour(gs);
            case 9:
                return generateLevelFive(gs);
            case 10:
                return generateLevelSix(gs);
            case 11:
                return generateLevelSeven(gs);
            case 12:
                return generateLevelEight(gs);
            case 13:
                return generateLevelNine(gs);
            case 5:
                return generateLevelTen(gs);
            default: return null;
        }
    ...
    private static Level generateLevelTen(GameScreen gs){
        ...
        ((Planet)p3).initialize(new Vector2(-1850,900),120,18,false,"moon2_36x36.png",1,30,10.0f);
        ((Planet)p4).initialize(new Vector2(-2750,1500),320,50,true,"planet2_100x100.png",2,90,10.0f);

        ((Planet)p9).initialize(new Vector2(200,1450),120,18,false,"moon1_36x36.png",2,90,15.0f);
