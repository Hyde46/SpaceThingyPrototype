...
//
//        // planets
//        ((Planet)p8).initialize(new Vector2(-4400,4000),50,Planet.TypeOrbit.G240,"planet7_100x100.png",2,10,0.0f);
//        ((Planet)p2).initialize(new Vector2(-3800,3900),50,Planet.TypeOrbit.B240,"planet2_100x100.png",2,40,10.0f);
//        ((Planet)p3).initialize(new Vector2(-2900,2760),50,Planet.TypeOrbit.B240,"planet9_100x100.png",1,30,10.0f);
//        ((Planet)p4).initialize(new Vector2(-2800,2200),50,Planet.TypeOrbit.B240,"planet2_100x100.png",2,90,10.0f);
//        ((Planet)p5).initialize(new Vector2(-1150,1650),36,Planet.TypeOrbit.B240,"planet1_72x72.png",1,120,10.0f);
//        ((Planet)p6).initialize(new Vector2(-400,1400),50,Planet.TypeOrbit.B240,"planet42_100x100.png",2,10,10.0f);
//        ((Planet)p11).initialize(new Vector2(-700,450),50,Planet.TypeOrbit.B240,"planet7_100x100.png",2,10,10.0f);
//        ((Planet)p1).initialize(new Vector2(0,0),36,Planet.TypeOrbit.B240,"planet1_72x72.png",1,0,0);
//        ((SpaceShip)playerShip).initialize(new Vector2(180,0),new Vector2(0,400),(Planet)p1,180,new Vector2(40,40));
//
//        // moons
