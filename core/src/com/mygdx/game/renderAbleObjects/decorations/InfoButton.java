...
public class InfoButton extends Decoration implements IInputHandler
{
    ...
    public void initialize(Vector2 position, int width, int height, String pathToTexture, int id, int idReturn)
    {
    ...
    {
        MyGdxGame.game.openScreen(new ItemScreen(id, idReturn));
    }
